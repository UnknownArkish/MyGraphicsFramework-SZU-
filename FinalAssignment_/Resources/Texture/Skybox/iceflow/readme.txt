=======================================================
Date:             8th of January 2001.
file:             sb-iceflowtga.zip
author:           Sock 
...
Instructions for using the Iceflow Skybox
----------------------------------------
...
4. Close the file and open Q3Radiant and you should
   find on the texture menu the ICEFLOW subdirectory.
   
5. Choose the ICEFLOW subdirectory and you should find
   the sky texture ready for use.
   
6. If the editor displays 2 textures use the one
   called ICEFLOW_SKYBOX. The other one is just so
