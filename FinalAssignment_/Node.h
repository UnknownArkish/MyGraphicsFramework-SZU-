...
protected:
	Node * m_Parent;					// 父节点
	std::vector<Node*> m_Childrens;		// 当前节点的所有子节点
private:
...
public:
	...
	void SetInstanceMatrix(mat4 matrix);						// 设置实例矩阵
	...
	mat4 GetInstanceMatrix() { return m_InstanceMatrix; }
	mat4 GetRenderMatrix() { return GetGlobalMatrix() * GetInstanceMatrix(); }		// 实际渲染使用的矩阵
